...
(function($) {
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            button: "파일선택",
            feedback: "이미지 파일들을 선택해주세요.(중복선택가능)",
            feedback2: "개의 파일이 선택되었습니다.",
            drop: "Drop file here to Upload",
            removeConfirmation: "목록에서 삭제하시겠습니까?",
            errors: {
                filesLimit: "최대 3개까지 업로드 가능합니다.",
                filesType: "이미지 파일(jpg, gif, png, bmp)만 업로드 가능합니다.",
                filesSize: "{{fi-name}} 파일의 용량이 너무 큽니다.\n최대 {{fi-fileMaxSize}} MB까지 업로드 가능합니다.",
                filesSizeAll: "총 {{fi-maxSize}} MB까지 업로드 가능합니다.",
